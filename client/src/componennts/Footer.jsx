  ...
  return (
    <div style={{background: "rgba(250, 250, 250, 0.50)"}}>
        <div className=' py-12 mx-8 md:mx-12 xl:mx-auto xl:max-w-6xl'>
            <div className='flex gap-4  md:items-center justify-between flex-col md:flex-row md:flex-wrap md:gap-12 lg:gap-0 lg:flex-nowrap font-aeonik capitalize'>
               ...
               <div>
                    <ul>
                        ...
                        <li className='text-[#747474] text-sm font-medium mb-2'>Help Center</li>
               ...
               <div>
                    <ul>
                        ...
                        <li className='text-[#747474] text-sm font-medium mb-2'>Find Equipment</li>
                        <li className='text-[#747474] text-sm font-medium mb-2'>Apply for Loan</li>
                        <li className='text-[#747474] text-sm font-medium'>Parts Ordering</li>
                    </ul>
               </div>
               <div>
                    <ul>
                        <li className='text-eBlack font-bold text-base mb-4'>sellers</li>
                        <li className='text-[#747474] text-sm font-medium mb-2'>Sell Equipment</li>
                        <li className='text-[#747474] text-sm font-medium mb-2'>Request Valuation</li>
                        <li className='text-[#747474] text-sm font-medium'>Repair Services</li>
                    </ul> 
               </div>
               <div>
                    <ul>
            ...
            <p className='text-center text-sm text-[#747474] mt-4'>Building Africa’s most trusted marketplace for heavy equipment, parts, and repairs.</p>
        </div>
    </div>
  )
}
