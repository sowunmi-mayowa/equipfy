...
const Categories = () => {
  ...
  return (
    <div className='mx-8 md:mx-12 xl:mx-auto xl:max-w-6xl'>
        <div className='mb-4'>
            <h3 className='font-plex text-xl md:text-2xl lg:text-[40px] capitalize font-semibold lg:mb-4'>Shop by Category</h3>
            <p className='text-[#747474] font-aeonik font-medium text-sm md:text-base max-w-[200px] md:max-w-lg inline-block md:block'>Find the right machine for your next project</p>
        </div>
