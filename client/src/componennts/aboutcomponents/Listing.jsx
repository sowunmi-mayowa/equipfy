  ...
  return (
    <div className='mx-8 overflow-x-auto  md:mx-12 xl:mx-auto xl:max-w-6xl'>
        <div className='flex justify-between'>
            <div className='mb-4'>
                <h3 className='font-plex text-xl md:text-2xl lg:text-[40px] capitalize font-semibold lg:mb-4'>Recently Added Equipment</h3>
                <p className='text-[#747474] font-aeonik font-medium text-sm md:text-base max-w-[200px] md:max-w-lg inline-block md:block'>Every machine below has been physically inspected and includes a downloadable 180-point PDF report.</p>
            </div>
