  ...
  return (
    <div className='relative'>
        <div className='py-4 mx-8 md:mx-12 xl:mx-auto xl:max-w-6xl'>
            <div className='relative'>
                <h1 className='text-eBlack text-lg md:text-4xl lg:text-5xl xl:text-7xl font-semibold font-plex text-center relative'>Buy and sell used heavy equipment with absolute confidence.</h1> 
            ...
            <div className='flex justify-center items-center'>
                <p className='text-[#747474] text-center text-sm md:text-base font-medium my-4 leading-7 lg:my-8 inline-block max-w-xl'>eQuipfy is Africa’s most trusted marketplace for heavy machinery. We handle the 180-point inspections, secure escrow payments, and door-to-site delivery so you can focus on building.</p>
            </div>
            <div className='flex justify-center items-center'>
                <Link to='/buy'>
        ...
        <div className='bg-eYellow mt-8'>
            <div className='py-4 mx-8 md:mx-12 xl:mx-auto xl:max-w-6xl flex flex-col md:flex-row md:gap-20 items-center'>
                <div className=''>
                    <h3 className='text-xl md:text-xl lg:text-3xl xl:text-4xl font-plex font-bold lg:max-w-lg'>Shop the World's Most Reliable Brands</h3>
                </div>
